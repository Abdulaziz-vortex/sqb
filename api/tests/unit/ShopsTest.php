...
class ShopsTest extends \PHPUnit\Framework\TestCase
{
    /*
     * !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    {
        $responce = $this->client->get($this->base_url.'/shops');
    ...
    {
        $data = [
            'name' => 'new shop nameassadasdsaddsa21asdasasdasdasdasas',
            'status' => true,
            'description' => 'description here'
        ];
        
        $response = $this->client->post($this->base_url.'/shops', [
            'json' => $data
        ]);
    ...
    public function testUpdate()
    {
        ...
        $response = $this->client->put($this->base_url.'/shops/'.$this->id, [
            'json' => $data
        ]);
    ...
    public function testDelete(){
        $response = $this->client->delete($this->base_url.'/shops/'.$this->id);
